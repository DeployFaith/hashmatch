...
**Purpose:** Adversarial intelligence extracted from agent research, mapped to concrete scenario mechanics, platform constraints, and failure-mode regression tests. Every entry is designed so an engineer can turn it into a GitHub issue.
...
### 8. Failure-Mode Regression Tests
Explicit regression tests against runner/gateway/viewer.
```
...
| 3        | FM-13 | JSON Malformation             | Tests the tolerant decoder under adversarial input. Already partially tested but needs failure-mode regression coverage. |
...
_Last updated: 2026-02-08. Authored as adversarial intelligence for HashMatch scenario design. Every entry is designed so an engineer can turn it into a GitHub issue._
