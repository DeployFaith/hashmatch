...
* **Deterministic Execution** — All randomness flows through a seeded PRNG. Given the same seed and the same agents, a match produces *identical* results every time.
