...
export const HeistValidationCodes = {
  ...
  LayoutOverlap: "HEIST_LAYOUT_OVERLAP",
  LayoutDoorNotAdjacent: "HEIST_LAYOUT_DOOR_NOT_ADJACENT",
  LayoutAspectRatio: "HEIST_LAYOUT_ASPECT_RATIO",
  LayoutDisconnected: "HEIST_LAYOUT_DISCONNECTED",
